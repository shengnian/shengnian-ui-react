...
class Sidebar extends Component {
  ...
  renderSearchItems = () => {
    ...
    _.each((component) => {
      if (component._meta && new RegExp(`^${_.escapeRegExp(query)}`, 'i').test(component._meta.name)) {
        startsWithMatches.push(component)
      } else if (component._meta && new RegExp(_.escapeRegExp(query), 'i').test(component._meta.name)) {
