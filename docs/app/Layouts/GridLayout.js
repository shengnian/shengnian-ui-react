...
import { Container, Divider, Grid, Header, Image } from 'shengnian-ui-react'
...
const GridLayout = () => (
  <div>
    ...
    <Container text>
      ...
      <p>
        Since Shengnian UI's grid is based on flex box, a <code>left floated</code> item should come first, and a
