...
import { Card, Container, Header, Segment } from 'shengnian-ui-react'
  ...
  <Container>
    <Segment basic padded>
      <Header
        as='h1'
        content='Layouts'
        subheader='Examples of using Shengnian UI React'
      />
    </Segment>
    ...
    <Segment basic padded>
      ...
      <Card.Group stackable itemsPerRow='3'>
        ...
        <Card
          ...
          to='/layouts/grid'
          header='Grid'
          description='An introduction to using Shengnian UI grids.'
