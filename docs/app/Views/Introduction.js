...
import { shengnianUIDocsURL, repoURL } from 'docs/app/utils'
...
const Introduction = () => (
  <Container id='introduction-page'>
    ...
    <Segment basic padded>
      ...
      <p>
        Shengnian UI React is the official React integration for <a href={shengnianUIDocsURL}>Shengnian UI</a> .
      </p>
      <List>
