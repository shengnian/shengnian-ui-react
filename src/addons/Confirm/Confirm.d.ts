...
export interface ConfirmProps extends ModalProps {
  ...
  cancelButton?: ShengnianShorthandItem<ButtonProps>;

  /** The OK button text. */
  confirmButton?: ShengnianShorthandItem<ButtonProps>;

  /** The ModalContent text. */
  content?: ShengnianShorthandItem<ModalContentProps>;

  /** The ModalHeader text. */
  header?: ShengnianShorthandItem<ModalHeaderProps>;
