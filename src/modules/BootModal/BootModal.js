...
import Fade from '../../behaviors/BootFade/BootFade'
import {
...
class Modal extends React.Component {
  ...
  destroy() {
    ...
    document.body.className = mapToCssModules(cx(classes).trim(), this.props.cssModule)
  ...
  show() {
    ...
    document.body.className = mapToCssModules(cx(
      classes,
      'modal-open',
  ...
  renderModalDialog() {
    ...
    return (
      <div
        className={mapToCssModules(cx('modal-dialog', this.props.className, {
      ...
      >
        <div
          className={mapToCssModules(
            cx('modal-content', this.props.contentClassName),
            this.props.cssModule,
          )}
        >
          {this.props.children}
  ...
  renderChildren() {
        ...
        <TransitionGroup component='div' className={mapToCssModules(wrapClassName)}>
          {isOpen && (
            <Fade
              ...
              cssModule={cssModule}
              className={mapToCssModules(cx('modal', modalClassName), cssModule)}
              {...modalAttributes}
            >
          ...
          {isOpen && backdrop && (
            <Fade
              ...
              cssModule={cssModule}
              className={mapToCssModules(cx('modal-backdrop', backdropClassName), cssModule)}
            />
          )}
        </TransitionGroup>
      )
    ...
    return (
      <div className={mapToCssModules(wrapClassName)}>
        {isOpen && (
          <div
            className={mapToCssModules(cx('modal', 'show', modalClassName), cssModule)}
            {...modalAttributes}
          >
            {this.renderModalDialog()}
          </div>
        ...
        {isOpen && backdrop && (
          <div
            className={mapToCssModules(cx('modal-backdrop', 'show', backdropClassName), cssModule)}
          />
        )}
      </div>
    )
