...
import { ShengnianShorthandCollection, ShengnianShorthandItem } from '../../';
...
export interface AccordionAccordionProps {
  ...
  panels?: ShengnianShorthandCollection<AccordionPanelProps>;
}

export interface AccordionPanelProps {
  content: ShengnianShorthandItem<AccordionContentProps>;
  title: ShengnianShorthandItem<AccordionTitleProps>;
}
