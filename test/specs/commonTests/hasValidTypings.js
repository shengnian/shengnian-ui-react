...
const shorthandMap = {
  ShengnianShorthandContent: customPropTypes.contentShorthand,
  ShengnianShorthandItem: customPropTypes.itemShorthand,
  ShengnianShorthandCollection: customPropTypes.collectionShorthand,
}
